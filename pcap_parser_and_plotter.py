...
for folder_path in folder_path_list:
    ...
    for filename in file_list:
        ...
        result = [filename, load_list[j], avg*clk_period, tempP99*clk_period, tempP999*clk_period]
    ...
    with open(dir[0]+'/'+dir[1]+'/result/'+dir[1]+'_w_prio_cnt.csv', 'w') as f:
        # create the csv writer
        writer = csv.writer(f)

        # write a row to the csv file
        writer.writerow(["File Name", "Load" ,"Average", 
                                                 "p99_all", "p999_all", "p99_P0","p999_P0","p99_P1","p999_P1","p99_P2","p999_P2","p99_P3","p999_P3","p99_P4","p999_P4","p99_P5","p999_P5",
